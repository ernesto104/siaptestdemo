 ...
 * @author keily
 */
public class IU_PagarSalidasVxCobrar extends javax.swing.JFrame {

    /**
     * Creates new form PagarLetrasxCobrar
     */
    public IU_PagarSalidasVxCobrar() {
        initComponents();
   ...
   public void fechaSistema(){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SALIDAS VARIAS PENDIENTES POR COBRAR");

        JlFecha.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N

        jLabel3.setText("Nro de Salida Varia");
        ...
        jLabel11.setText("PAGOS Y/O CANCELACIONES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IU_PagarFacturasxCobrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IU_PagarSalidasVxCobrar().setVisible(true);
            }
        });
    }
