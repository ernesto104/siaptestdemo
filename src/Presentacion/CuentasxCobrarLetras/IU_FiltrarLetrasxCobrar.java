 ...
 * @author keily
 */
public class IU_FiltrarLetrasxCobrar extends javax.swing.JFrame {

    /**
     * Creates new form ImprimirCuentasxCobrar
     */
    public IU_FiltrarLetrasxCobrar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Toda Cta. Cte.");

        jRadioButton2.setText("1 Cliente");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IU_FiltrarLetrasxCobrar().setVisible(true);
            }
        });
    }
