...
public class IU_DetalleCuentasxCobrar extends javax.swing.JFrame {
    ...
    public void IniciarDetalles() {
        ...
        txt_fecha.setText(sdf.format(cab.getTipocambio().getFecha()));
        ...
        ArrayList<Detallees> lista = sd.Listar_DetalleEs_PorCabec(cb);
    ...
    private void initComponents() {
        ...
        jLabel13.setText("DETALLLE DE FACTURA / BOLETA");
