...
class LongTask {
    ...
    public LongTask() {
        ...
        Servicio_Repuesto se = new Servicio_Repuesto();

        //Compute length of task...
        //In a real program, this would figure out
        //the number of bytes to read or whatever.
        lengthOfTask = se.Totalrepuestos();
    }
        ...
        ActualTask() {
            ...
            while (!canceled && !done) {
                try {
                    ...
                    statMessage = "Estratificando " + current
                            + " repuestos de " + lengthOfTask + ".";
